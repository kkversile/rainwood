...
export default function RatePlansPage() {
  ...
  return <AdminLayout title="Rate Plans"><section className="ratePlansPage">
    <header className="ratePlansHeader"><div><h1>Rate Plans</h1><p>Manage your hotel&apos;s rate plans and availability</p></div><div className="ratePlansHeaderActions"><label className="ratePlansSearch"><Search size={18} /><input aria-label="Search rate plans" value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search rate plans, rooms or hotels..." /></label><button className="ratePlanAddButton" type="button" onClick={startCreate} disabled={!hotelId}><Plus size={18} /> Add Rate Plan</button></div></header>
