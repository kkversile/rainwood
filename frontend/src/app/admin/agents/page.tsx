...
export default function AgentsPage() {
  ...
  return <AdminLayout title="Agents">
    ...
    {assignmentAgent && <button className="agentRateModalFloatingSave btn" type="button" disabled={busy || !hotelFilter || !selectedMasterId || hotelConflicts} onClick={() => void saveAssignments()}>{busy ? 'Saving...' : 'Save assignment'}</button>}
  </AdminLayout>;
}
