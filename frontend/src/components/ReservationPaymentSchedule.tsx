...
export function amountDueNow(schedule?: PaymentSchedule | null) { return (schedule?.milestones ?? []).filter((item) => item.dueNow && Number(item.outstandingAmount) > 0.005).reduce((sum, item) => sum + Number(item.outstandingAmount), 0); }
