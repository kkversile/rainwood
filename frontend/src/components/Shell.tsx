...
const adminLinks = [['/admin/dashboard', 'Dashboard'], ['/admin/hotels', 'Manage Hotels'], ['/admin/rooms-inventory', 'Rooms & Inventory'], ['/admin/rate-plans', 'Rate Plans'], ['/admin/base-rate-import', 'Base Rate Import'], ['/admin/supplementary-charges', 'Supplementary Charges'], ['/admin/agents', 'Agents'], ['/admin/agent-mappings', 'Agent Access & Contract Rates'], ['/admin/reservations', 'Reservations'], ['/admin/contact-requests', 'Contact Requests'], ['/admin/payments', 'Payments'], ['/admin/reports', 'Reports'], ['/admin/axisrooms', 'AxisRooms'], ['/admin/jobs', 'Jobs'], ['/admin/users', 'Users'], ['/admin/settings', 'Site Settings'], ['/admin/audit-logs', 'Audit Logs']];
